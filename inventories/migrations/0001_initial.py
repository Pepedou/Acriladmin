    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch',
                 models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='back_office.BranchOffice',
                ...
                ('supervisor', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT,
                                                 ...
                                                 to=settings.AUTH_USER_MODEL, verbose_name='supervisor')),
            ],
            options={
            ...
            fields=[
                ...
                ('product',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventories.ProductDefinition',
                                   verbose_name='producto')),
                ('source_branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                    related_name='product_transfers_as_source_branch',
                                                    to='back_office.BranchOffice', verbose_name='sucursal de origen')),
                ('target_branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                    related_name='product_transfers_as_target_branch',
                                                    to='back_office.BranchOffice', verbose_name='sucursal de destino')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT,
                                    to=settings.AUTH_USER_MODEL, verbose_name='manufacturado por'),
        ),
        migrations.AddField(
