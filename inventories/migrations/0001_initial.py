    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.PositiveSmallIntegerField(choices=[(0, 'm'), (1, 'Kg'), (2, 's'), (3, 'pz')])),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('items', models.ManyToManyField(to='inventories.ConsumableInventoryItem')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_update', models.DateTimeField(auto_now=True)),
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='back_office.BranchOffice')),
                ('items', models.ManyToManyField(to='inventories.DurableGoodInventoryItem')),
                ('last_updater', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='back_office.Employee')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('number', models.CharField(max_length=50, primary_key=True, serialize=False)),
                ('state', models.PositiveSmallIntegerField(choices=[(0, 'En producción'), (1, 'En producto'), (2, 'Devuelto'), (3, 'Destruido')])),
                ('acquisition_date', models.DateField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_update', models.DateTimeField(auto_now=True)),
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='back_office.BranchOffice')),
                ('items', models.ManyToManyField(to='inventories.MaterialInventoryItem')),
                ('last_updater', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='back_office.Employee')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target', models.PositiveSmallIntegerField(choices=[(0, 'Producto'), (1, 'Material'), (2, 'Empleado'), (2, 'Recurso')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_update', models.DateTimeField(auto_now=True)),
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='back_office.BranchOffice')),
                ('items', models.ManyToManyField(to='inventories.ProductInventoryItem')),
                ('last_updater', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='back_office.Employee')),
