    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_branch', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='product_reimbursement_as_from_branch', to='back_office.BranchOffice', verbose_name='de la sucursal')),
                ('to_branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_reimbursement_as_to_branch', to='back_office.BranchOffice', verbose_name='a la sucursal')),
            ],
            options={
