    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cause',
                 models.PositiveSmallIntegerField(choices=[(0, 'Interna'), (1, 'Proveedor'), (2, 'Transferencia')],
                                                  default=0, verbose_name='causa')),
                ('date', models.DateTimeField(auto_now_add=True, verbose_name='fecha')),
                ('status',
                 models.PositiveSmallIntegerField(choices=[(0, 'Confirmada'), (1, 'Cancelada'), (2, 'Pendiente')],
                                                  default=2, verbose_name='estado')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_reviewed',
                 models.DateTimeField(blank=True, editable=False, null=True, verbose_name='fecha de revisión')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_confirmed', models.BooleanField(default=False, verbose_name='confirmada')),
                ('provider', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='back_office.Provider',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='inventories.Product',
                                              verbose_name='producto')),
                ('product_removal',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventories.ProductRemoval',
                                   verbose_name='salida')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='purchase_order',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventories.PurchaseOrder',
                                    verbose_name='orden de compra'),
        ),
    ]
