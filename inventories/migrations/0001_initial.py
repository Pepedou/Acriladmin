    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consumable',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventories.Consumable',
                                   verbose_name='consumible')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('line', models.PositiveSmallIntegerField(
                    choices=[(0, 'Acrílico'), (1, 'Policarbonato'), (2, 'Celular'), (3, 'Plástico'), (4, 'Lámina'),
                             (5, 'Rejillas'), (6, 'Domos'), (7, 'Siliciones'), (8, 'Otra')], default=8,
                    verbose_name='línea')),
                ...
                ('thickness',
                 models.DecimalField(decimal_places=2, default=0, max_digits=6, verbose_name='espesor (mm)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventories.Material',
                                               verbose_name='material')),
