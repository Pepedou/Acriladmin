    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='back_office.BranchOffice')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.PositiveIntegerField(default=0)),
                ('durable_good', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                   to='inventories.DurableGoodDefinition')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.PositiveSmallIntegerField(
                    choices=[(0, 'Creación'), (1, 'Edición'), (2, 'Eliminación'), (3, 'Transferencia')])),
                ('target', models.PositiveSmallIntegerField(
                    choices=[(0, 'Producto'), (1, 'Material'), (2, 'Empleado'), (3, 'Consumible'), (4, 'Recurso')])),
                ('datetime', models.DateTimeField(auto_now_add=True)),
                ('consumable', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                                 to='inventories.Consumable')),
                ('durable_good', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                                   to='inventories.DurableGood')),
                ('made_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='back_office.Employee')),
                ('material', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                               to='inventories.Material')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
