    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sales_agent',
                 models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='projects_as_sales_agent',
                                   to=settings.AUTH_USER_MODEL, verbose_name='agente de ventas')),
                ('supervisor',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='projects_supervised',
                ...
                ('vehicle', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                              to='inventories.DurableGood', verbose_name='vehículo utilizado')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='inventories.Material',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('durable_good',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventories.DurableGood',
                                   verbose_name='objeto')),
                ('requested_by',
                 models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='requested_repairs',
                                   to=settings.AUTH_USER_MODEL, verbose_name='solicitada por')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_definition',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventories.Product',
                                   verbose_name='producto')),
            ],
            options={
