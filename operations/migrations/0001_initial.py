    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost',
                 models.DecimalField(blank=True, decimal_places=2, default=0.0, max_digits=10, verbose_name='costo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='back_office.Employee',
                                             verbose_name='autor')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material',
                 models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='inventories.MaterialDefinition',
                                   verbose_name='material')),
                ('project_estimation',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='operations.ProjectEstimation',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.PositiveSmallIntegerField(default=0, verbose_name='cantidad')),
                ('product',
                 models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='inventories.ProductDefinition',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authorized_by',
                 models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='authorized_repairs',
                                   to='back_office.Employee', verbose_name='autorizada por')),
                ('durable_good',
                ...
                ('requested_by',
                 models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='requested_repairs',
                                   to='back_office.Employee', verbose_name='solicitada por')),
            ],
            options={
