    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('materials_used', models.ManyToManyField(to='inventories.MaterialDefinition', verbose_name='materiales utilizados')),
                ('products_used', models.ManyToManyField(to='inventories.ProductDefinition', verbose_name='productos utilizados')),
